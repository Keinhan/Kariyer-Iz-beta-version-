        ...
        <ul className="grid sm:grid-cols-2 xl:grid-cols-3 justify-between w-full px-6 mb-8 gap-6">
          <li>
            ...
            <label
              ...
              className="inline-flex items-center justify-between w-full p-5 h-[20rem] sm:h-[24rem] lg:h-[28rem] text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 "
            >
